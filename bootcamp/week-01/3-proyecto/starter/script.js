...
console.log('=========================================');
console.log('VENTA DE MUEBLES Y DECORACION - 3407186');
console.log('=========================================');
console.log('');
...
console.log('Categoría:  Cama Doble');
...
console.log('Dominio: VENTA DE MUEBLES Y DECORACION');
...
console.log('Diseño, estilo y tecnología en un solo lugar.');
